...
const Logs = () => {
  return (
    <div className="m-4 sm:m-6 lg:m-12 border-b-2 border-sky-400">
      ...
      <div className="pt-10 sm:pt-16 lg:pt-10 flex flex-wrap lg:flex-nowrap justify-between">
        ...
        <div className="flex items-end justify-center mt-6 lg:mt-0 relative group">
          ...
          <Image src="\assets\See All Arrow bt.svg"
          alt="Learn More"
          height={50}
          width={140}
      ...
      <div className="pb-10 sm:pb-16 lg:pb-20 pt-6 sm:pt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="w-full border shadow-sm rounded-3xl">
          <Image
          ...
          <h1 className="p-4 text-[12px] sm:text-[14px] leading-[18px] sm:leading-[21px] tracking-[-0.14px] text-left font-medium text-[#898989]">
            Ventilators are medical devices generally found in a healthcare setting, that provide respiratory support to patients who are incapable of the success of the company.
          </h1>
          <div className="relative  group w-full sm:w-auto">
  <button className=" mt-6 sm:mt-8 mb-6 xl:mb-4  mx-auto py-2 px-8 sm:px-12 lg:px-24 text-[14px] sm:text-[15px] leading-[20px] tracking-[-0.14px] border rounded-lg font-medium border-black block transition-all duration-300 opacity-100 group-hover:opacity-0">
    Learn More
  </button>
  <Image 
    ...
    height={80}
    width={270}
    className="absolute left-14 top-0 opacity-0 group-hover:opacity-100 transition duration-500"
  />
</div>
        </div>
        ...
        <div className="w-full border shadow-sm rounded-3xl">
          ...
          <h1 className="p-4 text-[12px] sm:text-[14px] leading-[18px] sm:leading-[21px] tracking-[-0.14px] text-left font-medium text-[#898989]">
            Electrosurgery is a technique often used in a medical or surgical context. An electrosurgical generator along with accessories are intended for cutting, coagulation, vessel sealing and resection
          </h1>
          <div className="relative group w-full sm:w-auto">
  <button className="mt-6 sm:mt-8 mb-6 mx-auto py-2 px-8 sm:px-12 lg:px-24 text-[14px] sm:text-[15px] leading-[20px] tracking-[-0.14px] border rounded-lg font-medium border-black block transition-all duration-300 opacity-100 group-hover:opacity-0">
    Learn More
  </button>
  <Image 
    src="\assets\LM long arrow bt.svg"
  ...
  />
        ...
        <div className="w-full border shadow-sm rounded-3xl">
          ...
          <h1 className="p-4 text-[12px] sm:text-[14px] leading-[18px] sm:leading-[21px] tracking-[-0.14px] text-left font-medium text-[#898989]">
            Blood pressure exomony indicates us how to place some value to indicates how hard your heart works (at rest as well as during a physical activity) and the condition of your blood vessels.
          </h1>
          <div className="relative group w-full sm:w-auto">
  <button className="mt-6 sm:mt-8 mb-6 mx-auto py-2 px-8 sm:px-12 lg:px-24 text-[14px] sm:text-[15px] leading-[20px] tracking-[-0.14px] border rounded-lg font-medium border-black block transition-all duration-300 opacity-100 group-hover:opacity-0">
    Learn More
